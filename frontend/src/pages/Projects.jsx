        ...
        <DialogContent className="sm:max-w-[900px] bg-surface text-text border border-border/80 shadow-2xl rounded-xl overflow-hidden p-0 flex flex-col max-h-[90vh]">
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col h-full overflow-hidden">
              ...
              {/* Attachment Section */}
              <div className="pb-1">
                <p className="text-[10px] font-bold uppercase tracking-wider text-text2 mb-1.5">Attach Project Document</p>
                ...
                {savedAttachment ? (
                  ...
                  ><Paperclip size={14} /> Click to attach a project document</button>
                )}
